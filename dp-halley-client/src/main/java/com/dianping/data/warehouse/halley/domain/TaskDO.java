...
public class TaskDO implements Serializable{
    ...
    @NotNull(message ="cycle is not null")
    private String cycle;
    @NotNull(message ="databaseSrc is not null")
    private String databaseSrc;
    @NotNull(message ="freq is not null")
    private String freq;
    ...
    @NotNull(message ="logFile is not null")
    private String logFile;
    @NotNull(message ="logHome is not null")
    private String logHome;
    @NotNull(message ="offset is not null")
    private String offset;
    @NotNull(message ="offsetType is not null")
    ...
    @NotNull(message ="successCode is not null")
    ...
    @NotNull(message ="taskName is not null")
    private String taskName;
    @NotNull(message ="taskObj is not null")
    ...
    @NotNull(message ="updateUser is not null")
